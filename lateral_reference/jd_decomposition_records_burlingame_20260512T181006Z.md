...
**Specs landed at this canonical timestamp:** 5 total (4 Water Division + 1 Planning Department).
- Water Division (9-spec cohort, 4 landed): Water Division Manager (partial fidelity), Water System Operator Trainee (verbatim), Water System Operator (verbatim), Water Quality Supervisor (verbatim).
